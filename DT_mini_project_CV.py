...
#Set up logging
logging.basicConfig(filename='DT_model_deployment.log', level=logging.INFO,
...
#Save model
model_filename = "iris_production_classifier_v2_DT.pk1"
...
with open ('DT_model_deployment.log', 'r') as log_file:
    print ("\n===Deployment Log===")
    print(log_file.read())
